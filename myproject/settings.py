...
SECRET_KEY = "django-insecure-3*vlbg1rhoher*i3t3=p)fn2^b7$6fpdhnh3#eityyyo$)s27("
...
CMS_TEMPLATES = (("index.html", _("Standard")),
                 ("about.html", _("About Template")),
                 ("service.html", _("Service Template")),
